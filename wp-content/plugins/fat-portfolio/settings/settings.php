        ...
        <div class="tab-setting active" id="tab-layout">
            <ul>
                ...
                <li class="field-group">
                    ...
                    <div class="fat-field">
                        <select name="title_image_popup_gallery">
                            <option value="image_title" <?php if ($fat_settings['title_image_popup_gallery'] === 'image_title') { echo 'selected';} ; ?> ><?php esc_html_e('Image title','fat-portfolio'); ?></option>
                            <option value="image_caption" <?php if ($fat_settings['title_image_popup_gallery'] === 'image_caption') { echo 'selected';} ; ?> ><?php esc_html_e('Image caption','fat-portfolio'); ?></option>
                            <option value="portfolio_title" <?php if ($fat_settings['title_image_popup_gallery'] === 'portfolio_title') { echo 'selected';} ; ?>><?php esc_html_e('Portfolio/Project title','fat-portfolio'); ?></option>
                        </select>
                    </div>
                </li>
                ...
                <li class="field-group">
                    ...
                    <div class="fat-field">
                        <input type="checkbox" name="load_script_first" value="1" <?php if (isset($fat_settings['load_script_first']) && $fat_settings['load_script_first'] === '1') {
                            echo 'checked';
                        } ?> >
                    </div>
                    <div class="fat-desc">
                ...
                <li class="field-group">
                    ...
                    <div class="fat-field">
                        <p>
                            <input type="checkbox" name="unload_script_modernizr" value="1" <?php if (isset($fat_settings['unload_script_modernizr']) && $fat_settings['unload_script_modernizr'] === '1') {
                                echo 'checked';
                            } ?> > Unload Modernizr
                        </p>
                        <p>
                            <input type="checkbox" name="unload_script_isotope" value="1" <?php if (isset($fat_settings['unload_script_isotope']) && $fat_settings['unload_script_isotope'] === '1') {
                                echo 'checked';
                            } ?> > Unload Isotope
                        </p>
                        <p>
                            <input type="checkbox" name="unload_script_owl_carousel" value="1" <?php if (isset($fat_settings['unload_script_owl_carousel']) && $fat_settings['unload_script_owl_carousel'] === '1') {
                                echo 'checked';
                            } ?> > Unload Owl-Carousel
                        </p>
                        <p>
                            <input type="checkbox" name="unload_script_magnific_popup" value="1" <?php if (isset($fat_settings['unload_script_magnific_popup']) && $fat_settings['unload_script_magnific_popup'] === '1') {
                                echo 'checked';
                            } ?> > Unload Magnific Popup
                        </p>
                        <p>
                            <input type="checkbox" name="unload_script_light_gallery" value="1" <?php if (isset($fat_settings['unload_script_light_gallery']) && $fat_settings['unload_script_light_gallery'] === '1') {
                                echo 'checked';
                            } ?> > Unload Light Gallery
                        </p>
                        <p>
                            <input type="checkbox" name="unload_script_flipster" value="1" <?php if (isset($fat_settings['unload_script_flipster']) && $fat_settings['unload_script_flipster'] === '1') {
                                echo 'checked';
                            } ?> > Unload flipster carousel
                        </p>
                        <p>
                            <input type="checkbox" name="unload_script_waterwheel_carousel" value="1" <?php if (isset($fat_settings['unload_script_waterwheel_carousel']) && $fat_settings['unload_script_waterwheel_carousel'] === '1') {
                                echo 'checked';
            ...
            <ul>
                ...
                <li class="field-group">
                    ...
                    <div class="fat-field">
                        <input type="number" name="single_big_image_size_width" id="single_big_image_size_width"
                            ...
                            value="<?php echo esc_attr($fat_settings['single_big_image_size_height']) ?>" type="number"
                            name="single_big_image_size_height" id="single_big_image_size_height" class="number" /> (px)
                    </div>
                    <div class="fat-desc">
                        <span
                ...
                <li class="field-group">
                    ...
                    <div class="fat-field">
                        <input type="number" name="single_small_image_size_width" id="single_small_image_size_width"
                            ...
                            value="<?php echo esc_attr($fat_settings['single_small_image_size_height']) ?>" type="number"
                            name="single_small_image_size_height" id="single_small_image_size_height" class="number" /> (px)
                    </div>
                    <div class="fat-desc">
                        <span
               ...
               <!-- <li class="field-group">
                ...
                <li class="field-group">
                    ...
                    <div class="fat-field">
                        <p>
                            <input type="checkbox" name="single_unload_header" value="1" <?php if (isset($fat_settings['single_unload_header']) && $fat_settings['single_unload_header'] === '1') {
                                echo 'checked';
                            } ?> > <?php esc_html_e('Unload Header','fat-portfolio'); ?>
                        </p>
                        <p>
                            <input type="checkbox" name="single_unload_footer" value="1" <?php if (isset($fat_settings['single_unload_footer']) && $fat_settings['single_unload_footer'] === '1') {
                                echo 'checked';
                            } ?> > <?php esc_html_e('Unload Footer','fat-portfolio'); ?>
                        </p>
                        <p>
                            <input type="checkbox" name="single_unload_bootstrap" value="1" <?php if (isset($fat_settings['single_unload_bootstrap']) && $fat_settings['single_unload_bootstrap'] === '1') {
                                echo 'checked';
