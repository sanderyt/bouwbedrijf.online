...
<div class="fat-thumbnail" id="fat-thumbnail-<?php the_ID() ?>">
    ...
    <div class="fat-hover-wrap transition-slow">
        <a href="<?php echo esc_attr($link_to_detail); ?>"
           class="image-click-able <?php echo esc_attr($link_class); ?>"></a>
        <div class="fat-hover-inner transition-slow">
            <div class="fat-excerpt">
                <a href="<?php echo esc_attr($link_to_detail); ?>" class="<?php echo esc_attr($link_class); ?>">
                    <?php
...
<div class="fat-title-wrap text-center">
    <div class="title">
        <a href="<?php echo esc_url($link_to_detail); ?>" title="<?php echo esc_attr($title); ?>">
