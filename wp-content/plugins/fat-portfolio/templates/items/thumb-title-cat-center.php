    ...
    <div class="fat-thumbnail" id="fat-thumbnail-<?php the_ID() ?>">
        ...
        <div class="fat-hover-wrap transition-slow">
            <div class="fat-hover-inner transition-slow">
                <div class="icon">
                    <a href="<?php echo esc_url($url_origin); ?>" data-post-title="<?php echo esc_attr($title); ?>" data-post-id="<?php echo esc_attr($post_id); ?>" class="fat-view-gallery <?php echo esc_attr($light_box); ?>"
