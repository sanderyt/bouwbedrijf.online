...
<div class="fat-thumbnail" id="fat-thumbnail-<?php echo esc_attr($post_id); ?>">
    ...
    <div class="fat-hover-wrap transition-slow">
        <div class="fat-hover-inner transition-slow">
            <div class="icon">
                <a href="<?php echo esc_url($url_origin); ?>" data-post-id="<?php echo esc_attr($post_id); ?>" data-post-title="<?php echo esc_attr($title); ?>" class="fat-view-gallery <?php echo esc_attr($light_box); ?>"
                   data-guid="<?php echo esc_attr($id) ?>">
                    <i class="fa fa-search icon-effect"></i>
                </a>
            </div>
            <div class="title">
                <a href="<?php echo esc_url($url_origin); ?>" data-post-id="<?php echo esc_attr($post_id); ?>" data-post-title="<?php echo esc_attr($title); ?>" data-guid="<?php echo esc_attr($id) ?>" class="fat-view-gallery <?php echo esc_attr($light_box); ?>" title="<?php echo esc_attr($title); ?>">
