...
class fat_cmb_number
{
    ...
    public function render()
    {
        ...
        ?>
        <div
            class="<?php echo esc_attr($this->col_width) ?> <?php echo esc_attr($this->css_class) ?> fat-cmb-number-wrap" <?php echo sprintf('%s', $data_depend_field); ?> >
            <label for="<?php echo esc_attr($this->id) ?>"><?php echo esc_attr($this->label) ?></label>
            <div class="fat-cmb-field">
                <input type="number" name="<?php echo esc_attr($field_name) ?>" value="<?php echo esc_attr($text); ?>"
                       data-field-id="<?php echo esc_attr($this->id) ?>"
                       id="<?php echo esc_attr($field_id) ?>"
                    <?php echo isset($this->min) ? sprintf('min=%d', $this->min) : ''; ?>
                    <?php echo isset($this->max) ? sprintf('max=%d', $this->max) : ''; ?>
                    <?php echo isset($this->step) ? sprintf('step=%d', $this->step) : ''; ?>
